...
-(IBAction)reportError:(id)sender
{
    if([MFMailComposeViewController canSendMail])
    {
        ...
        NSString* subject = [NSString stringWithFormat:@"Error in G.W.2 Codex version %@",appVersion];
...
-(IBAction)emailEntity:(id)sender
{
    if([MFMailComposeViewController canSendMail])
    {
        ...
        NSString* subject = [NSString stringWithFormat:@"Info on '%@' from G.W.2 Codex",[_entity Name]];
