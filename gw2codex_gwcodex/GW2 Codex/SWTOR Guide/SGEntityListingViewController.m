...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    void(^setupPreview)(id,UITableViewCell*) = ^(id object,UITableViewCell* cell) 
    {
        ...
        titleLabel.font = [UIFont fontWithName:@"HoeflerText-Black" size:15];
        titleLabel.textColor = [UIColor colorWithRed:0.862 green:0.141 blue:0.121 alpha:1.0];
        ...
        backgroundImageView.layer.shadowOffset = CGSizeMake(3,3);
