...
-(IBAction)emailNames:(id)sender
{
    if([MFMailComposeViewController canSendMail])
    {
        ...
        NSString* subject = @"My Generated Names from G.W.2 Codex";
        NSMutableString* body = [NSMutableString stringWithString:@"<html><body><i>I've generated some names that will fit right into Guild Wars 2.</i></br><br/><table>"];
        ...
        [body appendString:@"</div><br/><div><i>Get the ultimate Guild Wars 2 database, in the palm of your hand. <b>G.W.2 Codex</b> is avaliable on iOS now!</i><br/><br/><a href='http://itunes.apple.com/us/app/g.w.2-codex/id510839835?ls=1&mt=8'><img src='https://developer.apple.com/appstore/images/as_available_appstore_icon_20091006.png'/></a></div></body></html>"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.font = [UIFont fontWithName:@"HoeflerText-Regular" size:15];
