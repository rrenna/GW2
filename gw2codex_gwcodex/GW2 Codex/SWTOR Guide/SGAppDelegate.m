...
{
    //configure iRate
    [iRate sharedInstance].appStoreID = 510839835;
    [iRate sharedInstance].applicationName = @"G.W.2 Codex";
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSURL *storeUrl = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"GW2Codex" ofType:@"sqlite"]];
