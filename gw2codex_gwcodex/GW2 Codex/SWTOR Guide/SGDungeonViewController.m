...
#import "SGDungeonViewController.h"
#import "SGAppDelegate.h"

@implementation SGDungeonViewController
#pragma mark - Class methods
+(void)load
{
    [super load];
    [SGAppDelegate registerSelf:self asViewerForEntityNamed:@"SGDungeon"];
}
#pragma mark - View lifecycle
-(id)initWithEntity:(id)entity
{
    self = [super initWithEntity:entity andXibName:@"SGDungeonViewController"];
    return self;
}
- (void)viewDidLoad
{
    ...
    difficultyLabel.font = primaryFontOfSize(13.0);
    headlineLabel.font = primaryFontOfSize(13.0);
    
    difficultyLabel.text = [_entity valueForKey:@"GameLevel"];
